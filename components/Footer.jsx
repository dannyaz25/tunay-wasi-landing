        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{
              ...
              color: '#c4b297', lineHeight: 1.4, maxWidth: 360, margin: 0,
            }}>
              "La verdadera casa del café peruano — donde el grano y la mano que lo sembró
              caben en la misma bolsa."
            </p>
          </div>
          {[
            ...
            <div key={title}>
              <div style={{
                ...
                color: '#c96e4b', textTransform: 'uppercase', marginBottom: 20,
              }}>{title}</div>
              <ul style={{ listStyle: 'none', margin: 0, padding: 0, display: 'flex', flexDirection: 'column', gap: 12 }}>
                {items.map(it => (
                  <li key={it}>
                    ...
                    }} onMouseEnter={e => { e.currentTarget.style.color = '#8faf8a'; }}
                       onMouseLeave={e => { e.currentTarget.style.color = '#f2e0cc'; }}>
                      {it}
                    </a>
                  </li>
                ))}
