// Hero — large editorial layout, animated colibrí, terracotta CTA.
const Hero = () => {
  ...
  return (
    ...
    <section id="top" style={{
      ...
      <div style={{
        ...
        background: 'radial-gradient(80% 60% at 75% 30%, #e8c69e 0%, #f2e0cc 55%, #f2e0cc 100%)',
      }} />
      {/* blurred warm sun */}
      <div style={{
        position: 'absolute', top: '12%', right: '-8%', width: 520, height: 520, borderRadius: '50%',
        background: 'radial-gradient(circle, #c96e4b88 0%, #c96e4b00 70%)',
        filter: 'blur(22px)', zIndex: 0,
      }} />
      <div style={{
        position: 'absolute', bottom: '-10%', left: '-6%', width: 460, height: 460, borderRadius: '50%',
        background: 'radial-gradient(circle, #8faf8a55 0%, #8faf8a00 70%)',
        filter: 'blur(28px)', zIndex: 0,
      }} />

      {/* coffee branches */}
      <div style={{ position: 'absolute', left: -20, top: 80, width: 180, opacity: 0.55, zIndex: 1, ...fade(0.4) }}>
        <CoffeeBranch />
      </div>
      <div style={{ position: 'absolute', right: -10, bottom: 40, width: 160, opacity: 0.55, zIndex: 1, ...fade(0.55) }}>
        <CoffeeBranch flip />
      </div>
      ...
      <div style={{
        ...
        <div>
          ...
          <h1 style={{
            ...
            La verdadera
            <br />
            <span style={{ fontStyle: 'italic', fontWeight: 500, color: '#c96e4b' }}>casa </span>
            del café
            <br />
          ...
          <div style={{ display: 'flex', gap: 16, marginTop: 44, alignItems: 'center', flexWrap: 'wrap', ...fade(0.45) }}>
            <a href="#cafe" className="tw-cta-primary" style={{
              ...
              boxShadow: '0 18px 40px -16px #533b22aa, inset 0 1px 0 #ffffff33',
            ...
            <a href="#caficultores" style={{
              fontFamily: 'Montserrat, sans-serif', fontWeight: 500, fontSize: 14,
              letterSpacing: '0.06em',
              color: '#1f3028', textDecoration: 'none',
              padding: '20px 8px', borderBottom: '1px solid #1f3028',
              transition: 'all .3s ease',
            }} onMouseEnter={e => { e.currentTarget.style.color = '#c96e4b'; e.currentTarget.style.borderColor = '#c96e4b'; }}
               onMouseLeave={e => { e.currentTarget.style.color = '#1f3028'; e.currentTarget.style.borderColor = '#1f3028'; }}>
            ...
            {[
              ...
              <div key={l}>
                ...
                <div style={{
                  ...
                  color: '#533b22', letterSpacing: '0.16em', textTransform: 'uppercase', marginTop: 8,
                }}>{l}</div>
              </div>
            ))}
          </div>
        ...
        {/* right: image collage with floating colibrí */}
        <div style={{ position: 'relative', minHeight: 580, ...fade(0.25) }}>
          ...
          <div style={{
            ...
            background: '#f2e0cc', border: '1px solid #533b22',
          ...
          <div style={{
            ...
            border: '1px dashed #1f3028', display: 'flex', alignItems: 'center', justifyContent: 'center',
            background: '#f2e0cc', zIndex: 4,
      ...
      <div style={{
        ...
        <span style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: 10, letterSpacing: '0.32em', color: '#533b22', textTransform: 'uppercase' }}>
          Desliza
        </span>
      ...
      <style>{`
        ...
        .tw-cta-primary:hover {
          ...
          box-shadow: 0 22px 50px -16px #533b22cc, inset 0 1px 0 #ffffff22;
        }
        .tw-cta-primary:hover .tw-cta-arrow { transform: translateX(6px); }
        @media (max-width: 960px) {
          .tw-hero-grid { grid-template-columns: 1fr !important; gap: 60px !important; }
        }
      `}</style>
    </section>
    </React.Fragment>
