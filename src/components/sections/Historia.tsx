  ...
  return (
    <section id="historia" ref={ref} style={{ position: 'relative', padding: '100px 36px', background: '#1f3028', color: '#f2e0cc', overflow: 'hidden' }}>
      ...
      <div style={{ maxWidth: 1320, margin: '0 auto', position: 'relative' }}>
        <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', gap: 48, marginBottom: 48, flexWrap: 'wrap', ...reveal(0) }}>
          <div>
            ...
            <h2 style={{ fontFamily: 'Cormorant Garamond, serif', fontWeight: 700, fontSize: 'clamp(32px, 4vw, 58px)', lineHeight: 1.02, color: '#f2e0cc', margin: '16px 0 0', letterSpacing: '-0.01em', maxWidth: 680 }}>
              Por qué nació<br />
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '0.85fr 1.15fr', gap: 36, marginBottom: 36, ...reveal(0.1) }} className="tw-2col">
          <div style={{ background: 'linear-gradient(135deg, #2a3d33 0%, #1f3028 100%)', border: '1px solid #c96e4b33', borderRadius: 24, overflow: 'hidden', minHeight: 360 }}>
            <ImageSlot label="retrato · Danny Santa Cruz · fundador" tone="green" ratio="3 / 4" />
          </div>
          <div style={{ background: 'linear-gradient(135deg, #2a3d33 0%, #1f3028 60%)', border: '1px solid #f2e0cc14', borderRadius: 24, padding: 32, display: 'flex', flexDirection: 'column', gap: 16, boxShadow: '0 32px 64px -32px #000000bb' }}>
            ...
            <h3 style={{ fontFamily: 'Cormorant Garamond, serif', fontWeight: 600, fontSize: 'clamp(22px, 3vw, 36px)', color: '#f2e0cc', margin: 0, lineHeight: 1.05 }}>
            ...
            <div style={{ borderLeft: '3px solid #c96e4b', paddingLeft: 24 }}>
              <p style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: 20, fontStyle: 'italic', color: '#f2e0cc', margin: 0, lineHeight: 1.35 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 20, marginBottom: 40 }} className="tw-historia-grid">
          {CARDS.map((c, i) => (
            <div key={i} style={{ background: 'linear-gradient(135deg, #2a3d33 0%, #1f3028 100%)', border: `1px solid ${(c as { border?: string }).border ?? '#f2e0cc14'}`, borderRadius: 24, padding: 28, display: 'flex', flexDirection: 'column', gap: 12, boxShadow: (c as { border?: string }).border ? '0 24px 48px -24px #c96e4b33' : undefined, ...reveal(0.18 + i * 0.08) }}>
              <div style={{ fontSize: 28 }}>{c.icon}</div>
              <h3 style={{ fontFamily: 'Cormorant Garamond, serif', fontWeight: 600, fontSize: 24, color: '#f2e0cc', margin: 0, lineHeight: 1.1 }}>{c.title}</h3>
        ...
        <div style={{ padding: '28px 36px', background: 'linear-gradient(135deg, #c96e4b12 0%, #1f302800 100%)', border: '1px solid #c96e4b33', borderRadius: 28, display: 'flex', gap: 36, alignItems: 'center', flexWrap: 'wrap', ...reveal(0.42) }}>
        ...
        <div style={{ marginTop: 44, textAlign: 'center', ...reveal(0.5) }}>
