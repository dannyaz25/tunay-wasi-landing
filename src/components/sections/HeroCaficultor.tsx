...
export default function HeroCaficultor() {
        ...
        <div style={{ position: 'relative', zIndex: 2, maxWidth: 1320, margin: '0 auto', padding: '0 36px', display: 'grid', gridTemplateColumns: '1.15fr 0.85fr', gap: 64, alignItems: 'center' }} className="tw-hero-grid">
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 28, ...fade(0.05) }}>
              ...
              <span style={{ fontFamily: 'Bowlby One SC, sans-serif', fontSize: 11, letterSpacing: '0.32em', color: '#533b22', textTransform: 'uppercase' }}>Para caficultores · Perú · 2026</span>
            </div>
            <h1 style={{ fontFamily: 'Cormorant Garamond, serif', fontWeight: 700, color: '#1f3028', fontSize: 'clamp(38px, 4.5vw, 80px)', lineHeight: 0.95, letterSpacing: '-0.015em', margin: 0, ...fade(0.15) }}>
              El acopiador compra tu café.<br />
              Tunay Wasi vende{' '}
              <span style={{ fontStyle: 'italic', fontWeight: 500, color: '#c96e4b' }}>tu historia.</span>
            </h1>
            <p style={{ fontFamily: 'Montserrat, sans-serif', fontWeight: 400, color: '#1f3028', fontSize: 16, lineHeight: 1.6, maxWidth: 520, marginTop: 24, ...fade(0.3, 0.82) }}>
              Tu nombre, tu finca y tu proceso en cada bolsa que llega al consumidor.
              Sin intermediarios. Hasta <strong>+122% más</strong> que el acopiador tradicional.
            </p>
            <div style={{ display: 'flex', gap: 16, marginTop: 32, alignItems: 'center', flexWrap: 'wrap', ...fade(0.45) }}>
              <a href="#registro" className="tw-cta-primary" style={{ fontFamily: 'Montserrat, sans-serif', fontWeight: 600, fontSize: 14, letterSpacing: '0.08em', textTransform: 'uppercase', color: '#f2e0cc', background: '#c96e4b', padding: '20px 32px', borderRadius: 999, textDecoration: 'none', boxShadow: '0 18px 40px -16px #533b22aa, inset 0 1px 0 #ffffff33', display: 'inline-flex', alignItems: 'center', gap: 12, transition: 'all .35s cubic-bezier(.2,.7,.2,1)', border: '1px solid #533b2244' }}>
                Registrar mi café
                <span style={{ display: 'inline-block', transition: 'transform .35s ease' }} className="tw-cta-arrow">→</span>
              </a>
              <a href="#calculadora" style={{ fontFamily: 'Montserrat, sans-serif', fontWeight: 500, fontSize: 14, letterSpacing: '0.06em', color: '#1f3028', textDecoration: 'none', padding: '20px 8px', borderBottom: '1px solid #1f3028', transition: 'all .3s ease' }}
            ...
            <div style={{ display: 'flex', gap: 36, marginTop: 48, flexWrap: 'wrap', ...fade(0.6) }}>
              {([
                ['+122%', 'más que el acopiador'],
                ['≥ 82 pts', 'puntaje SCA mínimo'],
                ['24 h', 'cata al recibir el lote'],
          ...
          <div style={{ position: 'relative', minHeight: 480, ...fade(0.25) }}>
            ...
            <div style={{ position: 'absolute', top: '6%', right: '4%', width: 100, height: 100, borderRadius: '50%', border: '1px dashed #1f3028', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#f2e0cc', zIndex: 4, transform: 'rotate(-12deg)' }}>
              <div style={{ textAlign: 'center', lineHeight: 1.1 }}>
                <div style={{ fontFamily: 'Bowlby One SC, sans-serif', fontSize: 10, color: '#c96e4b', letterSpacing: '0.18em' }}>+122%</div>
                <div style={{ fontFamily: 'Cormorant Garamond, serif', fontStyle: 'italic', fontSize: 11, color: '#1f3028', marginTop: 3 }}>más ingresos</div>
                <div style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: 8, color: '#533b22', marginTop: 3, letterSpacing: '0.18em' }}>vs. acopiador</div>
              </div>
            </div>
          </div>
        </div>
