...
const STATIC_PRODUCTS: Producto[] = [
  {
    id: 'sumaq-mayu', code: '01', name: 'Sumaq Mayu', sub: 'Lavado · Cusco',
    ...
    weights: [['250g', 7800], ['1kg', 27000], ['3kg', 76000]],
...
const STATIC_CAFICULTORES: Caficultor[] = [
  {
    id: 'eulalia-quispe', name: 'Doña Eulalia Quispe', farm: 'Finca Sumaq Mayu',
    region: 'Cusco · Calca', alt: '1,650 m', variety: 'Bourbon · Typica',
    process: 'Lavado', score: '86.5', color: 'green',
