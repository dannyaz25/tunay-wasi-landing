    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      ...
      <div style={{ padding: 24, borderRadius: 18, background: 'linear-gradient(180deg, #c96e4b14 0%, #1f302800 100%)', border: '1px solid #c96e4b44' }}>
        ...
        <div style={{ display: 'flex', gap: 12, justifyContent: 'center', alignItems: 'center', marginBottom: 16 }}>
          <span style={{ background: '#742280', color: '#f2e0cc', padding: '14px 32px', borderRadius: 12, fontFamily: 'Montserrat, sans-serif', fontSize: 18, fontWeight: 800 }}>yape</span>
          <span style={{ color: '#c4b297', fontFamily: 'Cormorant Garamond, serif', fontStyle: 'italic' }}>o</span>
          <span style={{ background: '#0bb4d9', color: '#f2e0cc', padding: '14px 32px', borderRadius: 12, fontFamily: 'Montserrat, sans-serif', fontSize: 18, fontWeight: 800 }}>plin</span>
        </div>
        <button onClick={() => onSubmit('yapePlin')} disabled={status === 'paying'} style={{ width: '100%', padding: 18, background: '#8faf8a', color: '#1f3028', border: 'none', borderRadius: 14, cursor: status === 'paying' ? 'not-allowed' : 'pointer', fontFamily: 'Montserrat, sans-serif', fontWeight: 700, fontSize: 14, letterSpacing: '0.06em', textTransform: 'uppercase', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: 10 }}>
          <span>💬</span> {status === 'paying' ? 'Procesando…' : 'Pagar con Yape / Plin'}
        </button>
        <div style={{ textAlign: 'center', fontFamily: 'Montserrat, sans-serif', fontSize: 11, color: '#c4b29799', marginTop: 10 }}>
        ...
        <div style={{ padding: '24px 32px 32px' }}>
          {status === 'done' ? (
            <div style={{ padding: '48px 0', textAlign: 'center' }}>
              ...
              <h3 style={{ fontFamily: 'Cormorant Garamond, serif', fontWeight: 600, fontSize: 38, color: '#f2e0cc', margin: 0 }}>¡Reservado!</h3>
              <p style={{ fontFamily: 'Montserrat, sans-serif', fontSize: 14, color: '#c4b297', marginTop: 14, maxWidth: 420, marginInline: 'auto', lineHeight: 1.6 }}>
                Pedido <strong style={{ color: '#f2e0cc' }}>#{orderId}</strong> registrado. Te escribimos por WhatsApp para confirmar el tueste y la entrega.
              </p>
        ...
        {status !== 'done' && (
          <div style={{ padding: '20px 32px', borderTop: '1px solid #f2e0cc18', background: '#182520', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 16 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
              <span style={{ fontFamily: 'Montserrat, sans-serif', fontSize: 12, color: '#8faf8a', display: 'inline-flex', alignItems: 'center', gap: 6 }}>💬 ¿Dudas?</span>
              {step === 'datos' && (
